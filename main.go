...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{t.TrainingType,
		t.Duration,
		t.distance(),
		t.meanSpeed(),
		t.Calories()}
...
func (r Running) Calories() float64 {
	...
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight /
		MInKm * r.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow((w.meanSpeed()*1000/3600), 2)/w.Height/100)*
...
func (s Swimming) Calories() float64 {
	//(средняя_скорость_в_км/ч + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier
	//* вес_спортсмена_в_кг * время_тренировки_в_часах
	return (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Training.Duration.Hours()
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{s.Training.TrainingType,
		s.Training.Duration,
		float64(s.LengthPool*s.CountPool) / 1000,
		s.meanSpeed(),
		s.Calories(),
	}
}
